...
- [ ] T011 Document and justify any new abstraction, provider boundary, or third-party dependency
...
- [ ] TXXX Re-run Constitution Check and remove unnecessary abstractions/dependencies before final verification
